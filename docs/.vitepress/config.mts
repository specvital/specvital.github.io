...
export default defineConfig({
          ...
          '/en/': [
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Parser Library Separation', link: '/en/adr/03-parser-library-separation' },
          ...
          '/ko/': [
            ...
            },
            {
              ...
              items: [
                ...
                { text: '파서 라이브러리 분리', link: '/ko/adr/03-parser-library-separation' },
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/specvital' }
    ],
